...
@Service
public class SysExpireConsumer implements MessageListener {
    ...
    public void onMessage(Message message) {
        try {
            ...
            //确认接收，并成功处理了消息
            weixinMessageService.sendSysExpire(expireVo.getOpenId(),expireVo.getTitle(),expireVo.getDay(),expireVo.getEndtime());
            message.acknowledge();
