...
public class DateUtil extends org.apache.commons.lang3.time.DateUtils {
     ...
     * @return
     */
    public static int getIntervalSeconds(int startHour, int endHour, int startMinute, int endMinute) {
        int second1 = (endHour - startHour) * 60 * 60;
        int second2 = (endMinute - startMinute) * 60;
     ...
     * @return
     */
    public static int getIntervalMinute(int startHour, int endHour, int startMinute, int endMinute) {
        int minute1 = (endHour - startHour) * 60;
        int minute2 = (endMinute - startMinute);
