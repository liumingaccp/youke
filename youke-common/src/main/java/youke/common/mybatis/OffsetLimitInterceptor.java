...
import youke.common.mybatis.dialect.Dialect;
import youke.common.mybatis.domain.PageBounds;
import youke.common.mybatis.domain.Paginator;
import youke.common.mybatis.support.PropertiesHelper;
...
public class OffsetLimitInterceptor implements Interceptor {
    ...
    public Object intercept(final Invocation invocation) throws Throwable {
      ...
      /*  final RowBounds rowBounds = (RowBounds)queryArgs[ROWBOUNDS_INDEX];
        ...
        final PageBounds pageBounds = PageContext.getPage();
        ...
        if (pageBounds.isContainsTotalCount()) {
            ...
            PageContext.getPage().setPaginator(countFutrue.get());
