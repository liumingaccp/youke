...
public class AuthorizeInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler){
        ...
        //排除读流
        String[] excludeReader = {"/common/applyagency","/upload","/gettoken","/addkefu","shopfans/import","/material/addimg", "/savekefuimg","/mass/callback","/alipayback","/mass/import"};
        //排除登录
        String[] excludeAuth = {"/common/","/news/","/member/tokenvalidate","/member/login","/member/register","/member/updatepwd","/weixin/","/dian/","/authback","/youzan","/tool/poster","/pay/wxpayback","/pay/alipayback","/mass/callback"};
        ...
        for (String exclude:excludeReader){
            if(path.toLowerCase().contains(exclude)){
                doReader = false;
                break;
            }
        }
        for (String exclude:excludeAuth){
            if(path.toLowerCase().contains(exclude)){
                doAuth = false;
                break;
            }
